...
const EVENT_FAMILIES = [
  ...
  },
  {
    ...
    dataSource: 'hardcoded',
    labelSources: [
      'Frozen 2024-2025 reference set curated from country-scale grid-crisis reports in IEA electricity analysis, RdipteshfWeb/OCHA humanitarian updates, and national operator/government notices.',
      'https://www.iea.org/reports/electricity-2025',
      'https://rdipteshfweb.int/',
    ],
  },
  {
    id: 'food-crisis',
