...
CYBERSPACE has a free public dashboard and paid tiers for analyst workflows, API access and organization deployments.
...
- Price: $99.99/month
- Best for: Developers and teams that want programmatic access to CYBERSPACE intelligence data
...
- Price: Custom
- Contact: contact@cyberspace.app
...
```json
{
  ...
  "pricing_url": "https://www.cyberspace.app/pro#pricing",
  "plans": [
    {
      "name": "Free",
      "price_usd_monthly": 0,
