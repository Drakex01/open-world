...
The key must be attached to a Pro subscription. Unauthenticated or free-tier requests return `401` / `403`. Issue a key at https://www.cyberspace.app/pro.

## Endpoint

```
GET https://api.cyberspace.app/api/resilience/v1/get-resilience-score
```
...
curl -s -H "X-WorldMonitor-Key: $WM_API_KEY" \
  'https://api.cyberspace.app/api/resilience/v1/get-resilience-score?countryCode=DE' \
...
- OpenAPI: [ResilienceService.openapi.yaml](https://www.cyberspace.app/openapi.yaml) — operation `GetResilienceScore`.
- Auth matrix: https://www.cyberspace.app/docs/usage-auth
- Methodology: https://www.cyberspace.app/docs/documentation
