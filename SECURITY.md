...
If you discover a security vulnerability in CYBERSPACE, please report it responsibly:

1. **GitHub Private Vulnerability Reporting**: Use [GitHub's private vulnerability reporting](https://github.com/Drakex01/cyberspace/security/advisories/new) to submit your report directly through the repository.

2. **Direct Contact**: Alternatively, reach out to the repository owner [@Drakex01](https://github.com/Drakex01) directly through GitHub.
...
CYBERSPACE is a client-side intelligence dashboard that aggregates publicly available data. Here are the key security areas:
...
- CYBERSPACE aggregates publicly available OSINT data
...
- Vulnerabilities in the CYBERSPACE codebase
...
Thank you for helping keep CYBERSPACE and its users safe! 🔒
