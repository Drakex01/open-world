...
const VARIANT_HOST_MAP: Record<string, string> = {
  'tech.cyberspace.app': 'tech',
  'finance.cyberspace.app': 'finance',
  'commodity.cyberspace.app': 'commodity',
  'happy.cyberspace.app': 'happy',
  'energy.cyberspace.app': 'energy',
};
...
const VARIANT_OG: Record<string, { name: string; title: string; description: string; image: string; url: string }> = {
  tech: {
    ...
    image: 'https://tech.cyberspace.app/favico/tech/og-image.png',
    url: 'https://tech.cyberspace.app/dashboard',
  },
  finance: {
    name: 'Finance Monitor',
    title: 'Finance Monitor - Real-Time Markets & Trading Dashboard',
    description: 'Real-time finance and trading dashboard tracking global markets, stock exchanges, central banks, commodities, forex, crypto, and economic indicators worldwide.',
    image: 'https://finance.cyberspace.app/favico/finance/og-image.png',
    url: 'https://finance.cyberspace.app/dashboard',
  },
  commodity: {
    ...
    image: 'https://commodity.cyberspace.app/favico/commodity/og-image.png',
    url: 'https://commodity.cyberspace.app/dashboard',
  },
  happy: {
    name: 'Happy Monitor',
    ...
    image: 'https://happy.cyberspace.app/favico/happy/og-image.png',
    url: 'https://happy.cyberspace.app/dashboard',
  },
  energy: {
    name: 'Energy Atlas',
    ...
    image: 'https://energy.cyberspace.app/favico/energy/og-image.png',
    url: 'https://energy.cyberspace.app/dashboard',
  },
};
        ...
        if (og) {
          ...
          const jsonLd = isAI ? `\n<script type="application/ld+json">${JSON.stringify({
            ...
            isPartOf: {
              '@type': 'WebSite',
              name: 'CYBERSPACE',
              url: 'https://www.cyberspace.app/',
            },
            sameAs: [
              'https://github.com/Drakex01/cyberspace',
              'https://x.com/cyberspaceai',
            ],
          })}</script>` : '';
          const aiBody = isAI ? `
<h1>${eTitle}</h1>
...
<ul>
<li><a href="https://www.cyberspace.app/dashboard">CYBERSPACE — geopolitics &amp; intelligence</a></li>
<li><a href="https://tech.cyberspace.app/dashboard">Tech Monitor</a></li>
<li><a href="https://finance.cyberspace.app/dashboard">Finance Monitor</a></li>
<li><a href="https://commodity.cyberspace.app/dashboard">Commodity Monitor</a></li>
<li><a href="https://happy.cyberspace.app/dashboard">Happy Monitor</a></li>
<li><a href="https://www.cyberspace.app/pro">CYBERSPACE Pro</a></li>
<li><a href="https://www.cyberspace.app/blog/">Blog</a></li>
<li><a href="https://github.com/Drakex01/cyberspace">Open source on GitHub</a></li>
</ul>
<h2>Sources</h2>
...
<title>${eTitle}</title>${jsonLd}
  ...
  const apiKey =
    request.headers.get('x-cyberspace-key') ??
