 ...
 * `cyberspace.app/mcp-grant` to the api-subdomain consent flow at
 * `api.cyberspace.app/oauth/authorize-pro` (U5).
 *
 * Flow:
 ...
 *
 * The redirect URL host is FIXED to `https://api.cyberspace.app` —
...
const AUTHORIZE_PRO_URL = 'https://api.cyberspace.app/oauth/authorize-pro';
