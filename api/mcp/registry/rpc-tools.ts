...
export const RPC_TOOLS: ToolDef[] = [
  {
    ...
    _execute: async (params, base, context) => {
      const UA = 'cyberspace-mcp-edge/1.0';
  ...
  },
  {
    ...
    _execute: async (params, base, context) => {
      ...
      const res = await fetch(url, {
        headers: { ...auth, 'User-Agent': 'cyberspace-mcp-edge/1.0' },
  ...
  },
  {
    ...
    _execute: async (params, base, context) => {
      ...
      const res = await fetch(url, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json', ...auth, 'User-Agent': 'cyberspace-mcp-edge/1.0' },
        body,
