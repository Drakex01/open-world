...
export const CACHE_TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    // but the handler at server/cyberspace/intelligence/v1/get-risk-scores.ts
  ...
  },
  {
    ...
    // server/cyberspace/military/v1/get-theater-posture.ts:23 reads 3 cascade
