...
const ALLOWED_ORIGINS = [
  ...
  /^https:\/\/cyberspace-[a-z0-9-]+-Drakex01--projects\.vercel\.app$/,
  /^https:\/\/cyberspace-[a-z0-9-]+\.vercel\.app$/,
  /^https?:\/\/localhost(:\d+)?$/,
  /^https?:\/\/127\.0\.0\.1(:\d+)?$/,
  /^tauri:\/\/localhost$/,
];
...
function sanitizeOrigin(raw) {
  return sanitizeAllowedOrigin(raw, 'https://cyberspace.app', ALLOWED_ORIGINS);
}
