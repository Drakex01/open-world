...
export default function handler(req, res) {
  const url = new URL(req.url, 'https://cyberspace.app');
  ...
  const baseUrl = 'https://cyberspace.app';
  ...
  const title = `${countryName} Intelligence Brief | CYBERSPACE`;
...
<head>
  ...
  <meta property="og:site_name" content="CYBERSPACE"/>

  <meta name="twitter:card" content="summary_large_image"/>
  <meta name="twitter:site" content="@Drakex01"/>
