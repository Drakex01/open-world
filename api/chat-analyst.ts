...
import { assembleAnalystContext } from '../server/cyberspace/intelligence/v1/chat-analyst-context';
import { buildAnalystSystemPrompt } from '../server/cyberspace/intelligence/v1/chat-analyst-prompt';
import { buildActionEvents } from '../server/cyberspace/intelligence/v1/chat-analyst-actions';
...
export default async function handler(req: Request): Promise<Response> {
  ...
  // the cross-origin api.cyberspace.app caller — also drops our CORS headers,
