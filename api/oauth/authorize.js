...
<body><a href="https://www.cyberspace.app" class="wm-logo" target="_blank" rel="noopener">${GLOBE_SVG}<span class="wm-logo-text">WorldMonitor MCP</span></a>
<div class="card"><h1>${escapeHtml(title)}</h1><p>${escapeHtml(detail)}</p><a href="javascript:history.back()" class="back">&#8592; go back</a></div>
<p class="footer"><a href="https://www.cyberspace.app" target="_blank" rel="noopener">cyberspace.app</a></p>
...
export function consentPage(params, nonce, errorMsg = '') {
  ...
  const proCtaHref = `https://cyberspace.app/mcp-grant?nonce=${encodeURIComponent(nonce)}`;
...
<body>
<a href="https://www.cyberspace.app" class="wm-logo" target="_blank" rel="noopener">${GLOBE_SVG}<span class="wm-logo-text">WorldMonitor MCP</span></a>
<div class="card">
<div class="client-hd">
...
<form id="cf" method="POST" action="https://api.cyberspace.app/oauth/authorize" style="display:none;margin-top:1.25rem">
...
<p class="hint">No key? <a href="https://www.cyberspace.app/pro" target="_blank" rel="noopener">Get one at cyberspace.app/pro &#x2192;</a></p>
<p class="error" id="ke"${errorMsg ? '' : ' style="display:none"'}>${errorMsg ? escapeHtml(errorMsg) : ''}</p>
<button type="submit" id="ab">Authorize</button>
</form>
</div>
<p class="footer"><a href="https://www.cyberspace.app" target="_blank" rel="noopener">cyberspace.app</a> &middot; <a href="https://www.cyberspace.app/pro" target="_blank" rel="noopener">Get an API key &#x2192;</a></p>
...
export default async function handler(req) {
  ...
  if (method === 'POST') {
    ...
    if (origin && origin !== 'https://api.cyberspace.app' && origin !== 'null') {
