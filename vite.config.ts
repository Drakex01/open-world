  ...
  return {
    ...
    transformIndexHtml(html) {
      let result = html
        ...
        .replace(/"name": "CYBERSPACE"/, `"name": "${activeMeta.siteName}"`)
        .replace(/"alternateName": "WorldMonitor"/, `"alternateName": "${activeMeta.siteName.replace(' ', '')}"`)
        .replace(/"url": "https:\/\/cyberspace\.app\/"/, `"url": "${activeMeta.url}"`)
  ...
  async function buildRouter() {
    const [
      ...
      shippingV2ServerMod, shippingV2HandlerMod,
        ...
        import('./src/generated/server/cyberspace/seismology/v1/service_server'),
        import('./server/cyberspace/seismology/v1/handler'),
        import('./src/generated/server/cyberspace/wildfire/v1/service_server'),
        import('./server/cyberspace/wildfire/v1/handler'),
        import('./src/generated/server/cyberspace/climate/v1/service_server'),
        import('./server/cyberspace/climate/v1/handler'),
        import('./src/generated/server/cyberspace/prediction/v1/service_server'),
        import('./server/cyberspace/prediction/v1/handler'),
        import('./src/generated/server/cyberspace/displacement/v1/service_server'),
        import('./server/cyberspace/displacement/v1/handler'),
        import('./src/generated/server/cyberspace/aviation/v1/service_server'),
        import('./server/cyberspace/aviation/v1/handler'),
        import('./src/generated/server/cyberspace/research/v1/service_server'),
        import('./server/cyberspace/research/v1/handler'),
        import('./src/generated/server/cyberspace/unrest/v1/service_server'),
        import('./server/cyberspace/unrest/v1/handler'),
        import('./src/generated/server/cyberspace/conflict/v1/service_server'),
        import('./server/cyberspace/conflict/v1/handler'),
        import('./src/generated/server/cyberspace/maritime/v1/service_server'),
        import('./server/cyberspace/maritime/v1/handler'),
        import('./src/generated/server/cyberspace/cyber/v1/service_server'),
        import('./server/cyberspace/cyber/v1/handler'),
        import('./src/generated/server/cyberspace/economic/v1/service_server'),
        import('./server/cyberspace/economic/v1/handler'),
        import('./src/generated/server/cyberspace/infrastructure/v1/service_server'),
        import('./server/cyberspace/infrastructure/v1/handler'),
        import('./src/generated/server/cyberspace/market/v1/service_server'),
        import('./server/cyberspace/market/v1/handler'),
        import('./src/generated/server/cyberspace/news/v1/service_server'),
        import('./server/cyberspace/news/v1/handler'),
        import('./src/generated/server/cyberspace/intelligence/v1/service_server'),
        import('./server/cyberspace/intelligence/v1/handler'),
        import('./src/generated/server/cyberspace/military/v1/service_server'),
        import('./server/cyberspace/military/v1/handler'),
        import('./src/generated/server/cyberspace/positive_events/v1/service_server'),
        import('./server/cyberspace/positive-events/v1/handler'),
        import('./src/generated/server/cyberspace/giving/v1/service_server'),
        import('./server/cyberspace/giving/v1/handler'),
        import('./src/generated/server/cyberspace/trade/v1/service_server'),
        import('./server/cyberspace/trade/v1/handler'),
        import('./src/generated/server/cyberspace/supply_chain/v1/service_server'),
        import('./server/cyberspace/supply-chain/v1/handler'),
        import('./src/generated/server/cyberspace/natural/v1/service_server'),
        import('./server/cyberspace/natural/v1/handler'),
        import('./src/generated/server/cyberspace/resilience/v1/service_server'),
        import('./server/cyberspace/resilience/v1/handler'),
        import('./src/generated/server/cyberspace/leads/v1/service_server'),
        import('./server/cyberspace/leads/v1/handler'),
        import('./src/generated/server/cyberspace/scenario/v1/service_server'),
        import('./server/cyberspace/scenario/v1/handler'),
        import('./src/generated/server/cyberspace/shipping/v2/service_server'),
        import('./server/cyberspace/shipping/v2/handler'),
      ]);
...
const RSS_PROXY_ALLOWED_DOMAINS = new Set([
  ...
  'idp.nature.com', 'chanakyaforum.com', 'www.livefistdefence.com', 'news.tuoitre.vn', 'www.google.com',
]);
    ...
    configureServer(server) {
      server.middlewares.use(async (req, res, next) => {
        ...
        if (!query) {
          res.statusCode = 400;
          res.setHeader('Content-Type', 'application/json');
          res.end(JSON.stringify({ error: 'Missing q parameter', videos: [] }));
          return;
        }
        ...
        try {
          ...
          if (!ytRes.ok) {
            res.statusCode = 500;
            res.setHeader('Content-Type', 'application/json');
            res.end(JSON.stringify({ error: 'Failed to fetch search results', videos: [] }));
            return;
          }
          ...
          res.statusCode = 500;
          res.setHeader('Content-Type', 'application/json');
          res.end(JSON.stringify({ error: 'Failed to search', videos: [] }));
        }
      });
    },
  };
  ...
  return {
    ...
    server: {
      ...
      proxy: {
        ...
        '/widget-agent': {
          target: 'https://proxy.cyberspace.app',
          changeOrigin: true,
        },
        // Yahoo Finance API
        '/api/yahoo': {
