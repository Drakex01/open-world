 ...
 *
 * The body was finalised on 2026-04-26 with Drakex01. Source-of-truth copy
...
export const PRO_LAUNCH_FROM = "Drakex01 from WorldMonitor <news@cyberspace.app>";
export const PRO_LAUNCH_REPLY_TO = "contact@cyberspace.app";
...
export const PRO_LAUNCH_UPGRADE_URL =
  "https://cyberspace.app/pro?utm_source=resend&utm_medium=email&utm_campaign=pro-launch&utm_content=launch-email";
 ...
 */
export const PRO_LAUNCH_TEXT = `I'm Drakex01, founder of WorldMonitor. PRO launched today (https://cyberspace.app/pro). I'm writing because you signed up a month ago, when the product was smaller and different.
...
It grew a dedicated energy variant. energy.cyberspace.app: live traffic and exposure on the four major shipping chokepoints, tanker positions in real time, 631 oil and gas pipelines mapped, global strategic storage atlas, refinery utilization, retail fuel prices.
...
More than half of this didn't exist 45 days ago. The open-source repo (https://github.com/Drakex01/cyberspace) crossed 50,000 GitHub stars in the same window. That's the build pace.
...
Native AI context. MCP server plus a 27-endpoint REST API — full docs at https://cyberspace.app/docs/documentation. Plug it into Claude, ChatGPT, Cursor, or anything you're building.
...
→ Upgrade to PRO: https://cyberspace.app/pro?utm_source=resend&utm_medium=email&utm_campaign=pro-launch&utm_content=launch-email
...
<p>I'm Drakex01, founder of WorldMonitor. <a href="https://cyberspace.app/pro?utm_source=resend&utm_medium=email&utm_campaign=pro-launch&utm_content=opener" style="color:#0066cc;">PRO launched today</a>. I'm writing because you signed up a month ago, when the product was smaller and different.</p>
...
<p><strong>It grew a dedicated energy variant.</strong> <a href="https://energy.cyberspace.app" style="color:#0066cc;">energy.cyberspace.app</a>: live traffic and exposure on the four major shipping chokepoints, tanker positions in real time, 631 oil and gas pipelines mapped, global strategic storage atlas, refinery utilization, retail fuel prices.</p>
...
<p>More than half of this didn't exist 45 days ago. The <a href="https://github.com/Drakex01/cyberspace" style="color:#0066cc;">open-source repo</a> crossed 50,000 GitHub stars in the same window. That's the build pace.</p>
...
<p><strong>Native AI context.</strong> MCP server plus a 27-endpoint REST API — <a href="https://cyberspace.app/docs/documentation" style="color:#0066cc;">full docs</a>. Plug it into Claude, ChatGPT, Cursor, or anything you're building.</p>
<p>Also included:</p>
...
<a href="https://cyberspace.app/pro?utm_source=resend&utm_medium=email&utm_campaign=pro-launch&utm_content=cta-button" style="display:inline-block;background:#111;color:#ffffff;text-decoration:none;padding:14px 28px;border-radius:6px;font-weight:600;">Upgrade to PRO with EARLYWM30 →</a>
</p>
