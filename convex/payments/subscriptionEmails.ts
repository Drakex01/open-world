...
const FROM = "CYBERSPACE <noreply@cyberspace.app>";
const ADMIN_EMAIL = "contact@cyberspace.app";
...
function userWelcomeHtml(planName: string, planKey: string): string {
  ...
  const ctaHref = isPro ? "https://cyberspace.app/brief" : "https://cyberspace.app";
...
export const sendSubscriptionEmails = internalAction({
  ...
  handler: async (_ctx, args) => {
    ...
    await sendEmail(
      apiKey,
      args.userEmail,
      `Welcome to CYBERSPACE ${planName}`,
