...
async function _createCheckoutSession(
  ...
  const siteUrl = process.env.SITE_URL ?? "https://cyberspace.app";
  ...
  if (args.returnUrl) {
    ...
    const allowedOrigins = new Set([
      ...
      "https://www.cyberspace.app",
      "https://app.cyberspace.app",
      "https://tech.cyberspace.app",
      "https://finance.cyberspace.app",
      "https://commodity.cyberspace.app",
      "https://happy.cyberspace.app",
      "https://energy.cyberspace.app",
      new URL(siteUrl).origin,
    ]);
    if (!allowedOrigins.has(parsedReturnUrl.origin)) {
      throw new ConvexError(
        "Invalid returnUrl: must use a trusted cyberspace.app origin",
      );
    }
