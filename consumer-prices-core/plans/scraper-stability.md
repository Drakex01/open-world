...
- src/snapshots/cyberspace.ts: retailer spread query — add AND pm.pin_disabled_at IS NULL
...
snapshots/cyberspace.ts buildRetailerSpreadSnapshot:
...
In cyberspace repo: src/services/consumer-prices/index.ts
...
21. Separate PR in cyberspace repo: remove ke from MARKETS (Task 11)
