...
// CYBERSPACE: no panel-level pro gating
...
export class PanelLayoutManager implements AppModule {
  ...
  private updatePanelGating(state: AuthSession): void {
    for (const [key, panel] of Object.entries(this.ctx.panels)) {
      ...
      // CYBERSPACE: all panels always unlocked — no secondary tier check
  ...
  private getGateAction(reason: PanelGateReason): () => void {
    switch (reason) {
      ...
      case PanelGateReason.FREE_TIER:
        return () => window.open('https://cyberspace.app/pro', '_blank');
      default:
        return () => {};
    }
  }
  ...
  async renderLayout(): Promise<void> {
    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header">
        ...
        return `
            <a href="${vHref('full', 'https://cyberspace.app/dashboard')}"
            ...
            <a href="${vHref('tech', 'https://tech.cyberspace.app')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('finance', 'https://finance.cyberspace.app')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('commodity', 'https://commodity.cyberspace.app')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('energy', 'https://energy.cyberspace.app')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('happy', 'https://happy.cyberspace.app')}"
          ...
          <span class="logo">MONITOR</span><span class="logo-mobile">CYBERSPACE</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
          <a href="https://github.com/Drakex01" target="_blank" rel="noopener" class="credit-link">
            <svg class="x-logo" width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            <span class="credit-text">@Drakex01</span>
          </a>
          <a href="https://github.com/Drakex01/cyberspace" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}">
      ...
      <nav class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">CYBERSPACE</span>
        ...
        <a class="mobile-menu-item" href="https://github.com/Drakex01" target="_blank" rel="noopener">
          ...
          <span class="mobile-menu-item-label">@Drakex01</span>
        </a>
        <div class="mobile-menu-divider"></div>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">CYBERSPACE</span>
            <span class="site-footer-sub">v${__APP_VERSION__} &middot; <a href="https://github.com/Drakex01" target="_blank" rel="noopener" class="site-footer-credit">@Drakex01</a></span>
          </div>
        </div>
        <!-- desktop nav links removed -->
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} CYBERSPACE</span>
      </footer>
  ...
  private async createPanels(): Promise<void> {
    ...
    this.createNewsPanel('india-intel', 'panels.indiaIntel');
    ...
    this.lazyPanel('network-activity', () =>
      import('@/components/NetworkActivityPanel').then(m => new m.NetworkActivityPanel())
    );

    this.lazyPanel('search-news', () =>
      import('@/components/SearchNewsPanel').then(m => new m.SearchNewsPanel())
    );
    ...
    // PRO badge removed — everything is free on CYBERSPACE
