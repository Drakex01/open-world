export const PANEL_SPANS_KEY = 'cyberspace-panel-spans';
export const PANEL_COL_SPANS_KEY = 'cyberspace-panel-col-spans';
export const PANEL_COLLAPSED_KEY = 'cyberspace-panel-collapsed';
