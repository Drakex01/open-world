...
const SETTINGS_KEY_PREFIXES: readonly string[] = [
  ...
  'cyberspace-live-channels',
  'cyberspace-active-channel',
  'cyberspace-runtime-feature-toggles',
  'wm-globe-render-scale',
  'wm-live-streams-always-on',
  'cyberspace-webcam-prefs',
  'wm-map-theme:',
  'map-height',
  'map-pinned',
...
export function exportSettings(): void {
  ...
  const exportData: ExportedSettings = {
    ...
    variant: localStorage.getItem('cyberspace-variant') || 'full',
    data,
  };
  ...
  a.download = `cyberspace-settings-${ts}.json`;
