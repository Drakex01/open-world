...
// server/cyberspace/resilience/v1/_dimension-scorers.ts). Duplicated
...
// `server/cyberspace/resilience/v1/_dimension-scorers.ts`. When a dim
...
// Mirrors server/cyberspace/resilience/v1/_shared.ts. Keep this table
...
// server/cyberspace/resilience/v1/_dimension-scorers.ts. The doc
