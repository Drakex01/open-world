...
function formatPositionSource(source: string): string {
  if (source === 'POSITION_SOURCE_WINGBITS') {
    return '<a href="https://wingbits.com?utm_source=cyberspace&utm_medium=referral&utm_campaign=cyberspace" target="_blank" rel="noopener" style="color:inherit">wingbits.com</a>';
  }
