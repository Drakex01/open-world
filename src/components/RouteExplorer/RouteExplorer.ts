...
import type { GetRouteExplorerLaneResponse, GetRouteImpactResponse, BypassCorridorOption } from '@/generated/server/cyberspace/supply_chain/v1/service_server';
    ...
    if (this.contentEl) {
      ...
      btn?.addEventListener('click', () => {
        ...
        void import('@/services/checkout')
          ...
          .catch(() => window.open('https://cyberspace.app/pro', '_blank'));
      }, { once: true });
    }
  }
