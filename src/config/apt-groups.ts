...
export const APT_GROUPS: APTGroup[] = [
  ...
  },
  {
    ...
    description: 'Middle Eastern group bDrakex01ved to be a customer of Gamma Group (FinSpy). Targets UN figures, opposition bloggers, activists, regional journalists, and think tanks.',
    tactics: ['Initial Access', 'Execution', 'Persistence', 'Collection'],
