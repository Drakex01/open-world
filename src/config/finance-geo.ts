...
export const FINANCIAL_CENTERS: FinancialCenter[] = [
  ...
  { id: 'fc-channelislands', name: 'Channel Islands', city: 'St. HDrakex01r', country: 'JE', lat: 49.1868, lon: -2.1091, type: 'offshore', specialties: ['Trusts', 'Private Banking', 'Fund Administration'], description: 'Offshore banking center' },
];
