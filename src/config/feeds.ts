...
export const SOURCE_TYPES: Record<string, SourceType> = {
  ...
  // India Intelligence
  'PIB Defence': 'gov', 'IDRW Defence': 'intel', 'Livefist Defence': 'intel',
  'India AI gov': 'gov', 'India Tech & AI': 'tech',
  'CERT-In Cyber': 'gov', 'India Cybersecurity': 'intel', 'PIB PMO': 'gov',
  // Hungarian (HU)
...
const FULL_FEEDS: Record<string, Feed[]> = {
  politics: [
    ...
    { name: 'WION News', url: rss('https://news.google.com/rss/search?q=site:wionews.com&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'ANI News', url: rss('https://news.google.com/rss/search?q=site:aninews.in&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'Times of India', url: rss('https://news.google.com/rss/search?q=site:timesofindia.indiatimes.com&hl=en-IN&gl=IN&ceid=IN:en') },
  ...
  thinktanks: [
    { name: 'IDRW (Indian Defence Research)', url: rss('https://news.google.com/rss/search?q=site:idrw.org&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'Livefist Defense', url: rss('https://www.livefistdefence.com/feed/') },
    { name: 'PIB Ministry of Defence (India)', url: rss('https://news.google.com/rss/search?q=site:pib.gov.in+Ministry+of+Defence&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'Chanakya Forum', url: rss('https://chanakyaforum.com/feed/') },
  ...
  'india-intel': [
    { name: 'PIB Defence', url: rss('https://news.google.com/rss/search?q=site:pib.gov.in+Ministry+of+Defence&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'IDRW Defence', url: rss('https://news.google.com/rss/search?q=site:idrw.org&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'Livefist Defence', url: rss('https://www.livefistdefence.com/feed/') },
    { name: 'India AI gov', url: rss('https://news.google.com/rss/search?q=site:indiaai.gov.in&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'India Tech & AI', url: rss('https://news.google.com/rss/search?q=(India+AI+OR+India+technology+OR+India+cyber)+when:3d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'CERT-In Cyber', url: rss('https://news.google.com/rss/search?q=site:cert-in.org.in+OR+CERT-In&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'India Cybersecurity', url: rss('https://news.google.com/rss/search?q=India+cybersecurity+OR+cyber+attack+India+when:3d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'PIB PMO', url: rss('https://news.google.com/rss/search?q=site:pib.gov.in+Prime+Minister&hl=en-IN&gl=IN&ceid=IN:en') },
  ],
};
...
// Energy variant feeds — energy.cyberspace.app
