...
export const LAYER_REGISTRY: Record<keyof MapLayers, LayerDefinition> = {
  ...
  indiaIntel:               def('indiaIntel',               '&#127470;&#127475;', 'indiaIntel', 'India Intelligence', ['flat', 'globe']),
};
...
export const LAYER_EXPLANATIONS: Partial<Record<keyof MapLayers, LayerExplanation>> = {
  ...
  natural: {
    ...
    evidence: ['docs/data-sources.mdx', 'docs/architecture.mdx', 'server/cyberspace/natural/v1/list-natural-events.ts'],
  },
  flights: {
    key: 'flights',
    coverage: 'curated',
  ...
  waterways: {
    ...
    evidence: ['docs/architecture.mdx', 'docs/data-sources.mdx', 'src/config/geo.ts', 'server/cyberspace/supply-chain/v1/get-chokepoint-status.ts'],
  },
  tradeRoutes: {
    key: 'tradeRoutes',
    coverage: 'curated',
  ...
  cyberThreats: {
    ...
    evidence: ['docs/data-sources.mdx', 'docs/architecture.mdx', 'scripts/seed-cyber-threats.mjs', 'server/cyberspace/cyber/v1/list-cyber-threats.ts'],
  },
  hotspots: {
    key: 'hotspots',
    coverage: 'curated',
