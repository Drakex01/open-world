...
// VITE_VARIANT=tech → tech.cyberspace.app (tech-focused)
// VITE_VARIANT=full → cyberspace.app (geopolitical)
// VITE_VARIANT=finance → finance.cyberspace.app (markets/trading)
