...
//      string as a prefix (e.g. `https://api.cyberspace.app.evil.example/`)
//      OR as the userinfo portion (`https://api.cyberspace.app@evil/`)
...
export function installWmSessionFetchInterceptor(): void {
  ...
  // request to https://api.cyberspace.app/api/* — the interceptor only
