...
export const DESKTOP_PARITY_FEATURES: DesktopParityFeature[] = [
  ...
  },
  {
    ...
    apiHandlers: ['server/cyberspace/conflict/v1/handler.ts', 'server/cyberspace/infrastructure/v1/handler.ts', 'server/cyberspace/cyber/v1/handler.ts', 'server/cyberspace/maritime/v1/handler.ts', 'server/cyberspace/military/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/cyberspace/news/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/cyberspace/market/v1/handler.ts'],
    locality: 'fully-local',
  ...
  },
  {
    ...
    apiHandlers: ['server/cyberspace/military/v1/handler.ts'],
    locality: 'api-key',
