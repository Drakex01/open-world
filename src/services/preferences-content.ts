...
const DESKTOP_RELEASES_URL = 'https://github.com/Drakex01/cyberspace/releases';
...
export function renderPreferences(host: PreferencesHost): PreferencesResult {
  ...
  `;
  html += `<a href="https://github.com/Drakex01/cyberspace" target="_blank" rel="noopener noreferrer" class="us-discussion-link">
