...
🌐 **[Live Demo: cyberspace.app](https://cyberspace.app)** | 💻 **[Tech Variant: tech.cyberspace.app](https://tech.cyberspace.app)**
...
![CYBERSPACE Dashboard](images/new-cyberspace.png)

## Platform Variants

CYBERSPACE runs two specialized variants from a single codebase, each optimized for different monitoring needs:

| Variant | URL | Focus |
|---------|-----|-------|
| **🌍 CYBERSPACE** | [cyberspace.app](https://cyberspace.app) | Geopolitical intelligence, military tracking, conflict monitoring, infrastructure security |
| **💻 Tech Monitor** | [tech.cyberspace.app](https://tech.cyberspace.app) | Technology sector intelligence, AI/startup ecosystems, cloud infrastructure, tech events |
...
The tech variant ([tech.cyberspace.app](https://tech.cyberspace.app)) provides specialized layers for technology sector monitoring.
...
The Service Status panel tracks the operational health of external services that CYBERSPACE users may depend on.
...
// App.ts
const header = `CYBERSPACE v${__APP_VERSION__}`;
```
...
- ✅ **Variant Switcher UI** - Compact orbital navigation between CYBERSPACE and Tech Monitor
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/cyberspace.git
   cd cyberspace
   ```
