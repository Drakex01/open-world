...
CYBERSPACE runs six thematic variants from a single codebase, each tailored to a different audience:

| Variant | Domain | Focus |
|---------|--------|-------|
| **CYBERSPACE** | cyberspace.app | Geopolitics, military, conflicts, infrastructure |
| **Tech Monitor** | tech.cyberspace.app | AI/ML, startups, cybersecurity, tech ecosystems |
| **Finance Monitor** | finance.cyberspace.app | Markets, central banks, Gulf FDI, commodities |
| **Commodity Monitor** | commodity.cyberspace.app | Mining, metals, energy, critical minerals |
| **Happy Monitor** | happy.cyberspace.app | Good news, conservation, positive global trends |
| **Energy Monitor** | energy.cyberspace.app | Energy security, oil and gas, chokepoints, policy response |

### AI Intelligence Layer

CYBERSPACE uses a multi-tier AI pipeline to process and summarize information:
...
CYBERSPACE aggregates publicly available data from dozens of sources. No proprietary or classified information is used. Key source categories:
...
CYBERSPACE serves several audiences:
...
| Feature | CYBERSPACE | Traditional OSINT Tools | News Aggregators |
|---------|--------------|------------------------|-----------------|
...
- **Web**: Available at cyberspace.app and variant subdomains
...
CYBERSPACE is actively developed with planned expansions across several areas:
...
- **API and MCP access** for developers and organizations to integrate CYBERSPACE data into their own tools
...
**Q: Where does CYBERSPACE get its data?**
...
**Q: Does CYBERSPACE track users or sell data?**
...
A: Yes. CYBERSPACE is licensed under AGPL-3.0, meaning anyone can inspect, audit, modify, and redistribute the code. If you run a modified version as a service, you must share your modifications under the same license.

**Q: Who built this?**
A: CYBERSPACE was created by Drakex01. It is an independent project, not affiliated with any government, intelligence agency, or defense contractor.

**Q: Can I embed CYBERSPACE or use its data in my reporting?**
A: The web interface can be referenced and linked in reporting. For data integration, use the documented REST API, OpenAPI specs, or MCP server. Please attribute "CYBERSPACE (cyberspace.app)" when referencing the platform in published work.

**Q: How is this different from Janes, Palantir, or Dataminr?**
A: Those are enterprise products costing tens to hundreds of thousands of dollars per year, typically sold to governments and large corporations. CYBERSPACE aims to democratize access to situational awareness by aggregating public data and using AI to make it digestible. It is open source, free to use, and designed for individual analysts and small teams, not just large organizations.
...
A: CYBERSPACE is primarily a solo project by its creator, with occasional open-source contributions from the community.
...
- **GitHub**: github.com/Drakex01/cyberspace
- **Website**: cyberspace.app

---

*This document was last updated March 2026. CYBERSPACE is an independent, open-source project licensed under AGPL-3.0.*
