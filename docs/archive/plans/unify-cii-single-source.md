...
|---|---|---|
| File | `src/services/country-instability.ts` | `server/cyberspace/intelligence/v1/get-risk-scores.ts` |
...
`src/generated/server/cyberspace/intelligence/v1/service_server.ts` +
`src/generated/client/cyberspace/intelligence/v1/service_client.ts`. Either way the
