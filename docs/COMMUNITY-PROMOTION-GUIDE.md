# CYBERSPACE — Community Promotion Guide

Thank you for helping spread the word about CYBERSPACE! This guide provides talking points, must-see features, and visual suggestions to help you create compelling content for your audience.
...
**Longer description**: CYBERSPACE aggregates 500+ news feeds, military tracking, financial markets, conflict data, protest monitoring, satellite imagery, and AI-powered analysis into a single unified dashboard with an interactive globe. Available as a web app, desktop app (macOS/Windows/Linux), and installable PWA.
...
| Link | Description |
|------|-------------|
| [cyberspace.app](https://cyberspace.app) | Main dashboard — geopolitics, military, conflicts |
| [tech.cyberspace.app](https://tech.cyberspace.app) | Tech variant — startups, AI/ML, cybersecurity |
| [finance.cyberspace.app](https://finance.cyberspace.app) | Finance variant — markets, exchanges, central banks |
| [commodity.cyberspace.app](https://commodity.cyberspace.app) | Commodity variant — mining, metals, energy, supply chains |
| [happy.cyberspace.app](https://happy.cyberspace.app) | Happy variant — positive news, breakthroughs, conservation |
| [energy.cyberspace.app](https://energy.cyberspace.app) | Energy variant — oil, gas, chokepoints, energy security |
| [GitHub](https://github.com/Drakex01/cyberspace) | Source code (AGPL-3.0) |
...
- **Name**: "CYBERSPACE" (two words, capitalized)
- **Tagline**: "Real-time global intelligence dashboard"
- **License**: AGPL-3.0 (free and open source)
- **Creator**: Credit "CYBERSPACE by Drakex01" or link to the GitHub repo
...
We genuinely appreciate community members helping grow CYBERSPACE's reach. Feel free to interpret these guidelines creatively — there's no strict template. The most compelling content comes from showing what YOU find most interesting or useful about the tool.
