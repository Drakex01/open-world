...
Prefer the canonical URLs in new code — the aliases will retire at the next v1→v2 break (tracked in [#3282](https://github.com/diptesh/worldmonitor/issues/3282)).
</Note>
