...
```typescript
// server/cyberspace/market/v1/list-tv-stock-screener.ts
...
- [ ] Create `proto/cyberspace/market/v1/list_tv_stock_screener.proto`
- [ ] Create `server/cyberspace/market/v1/list-tv-stock-screener.ts`
