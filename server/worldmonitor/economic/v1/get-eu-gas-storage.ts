...
function buildMockFallbackResult(): GetEuGasStorageResponse {
  return {
    ...
    trend: 'RISING',
    history: [
      { date: '2023-10-01', fillPct: 77.0, gasTwh: 840 },
      { date: '2023-10-02', fillPct: 77.5, gasTwh: 845 },
      { date: '2023-10-03', fillPct: 78.0, gasTwh: 850 },
      { date: '2023-10-04', fillPct: 78.38, gasTwh: 854 },
      { date: '2023-10-05', fillPct: 78.5, gasTwh: 855 },
    ],
