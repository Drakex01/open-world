...
description: "A plain-English explainer for maritime chokepoints, how CYBERSPACE tracks 13 waterways, why only seven publish live flow estimates today, and how to read status scores."
metaTitle: "What Is a Maritime Chokepoint? | CYBERSPACE"
...
That is the question CYBERSPACE's chokepoint model tries to make visible.
...
CYBERSPACE's canonical chokepoint registry currently monitors 13 waterways:
...
## How CYBERSPACE scores chokepoint status
...
For operational follow-through, connect this explainer to the [supply-chain scenario engine](/blog/posts/stress-test-supply-chain-scenario-engine-cyberspace/) and the [global trade route monitoring guide](/blog/posts/tracking-global-trade-routes-chokepoints-freight-costs/).

## Source transparency

CYBERSPACE's chokepoint status combines Redis-backed transit summaries, flow estimates, navigational warnings, AIS disruption matching, and a static threat taxonomy. Upstream gaps are surfaced as unavailable data rather than silently turned into calm conditions.
