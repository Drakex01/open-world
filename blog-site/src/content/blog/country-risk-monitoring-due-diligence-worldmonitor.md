---
title: "Country Risk Due Diligence with CYBERSPACE"
...
metaTitle: "Country Risk Monitoring for Due Diligence | CYBERSPACE"
...
heroImage: "/blog/og/country-risk-monitoring-due-diligence-cyberspace.png"
pubDate: "2026-06-10"
...
The [Country Instability Index methodology](https://www.cyberspace.app/docs/methodology/cii-risk-scores) gives each country a 0-100 instability score with component-level context. Use it as a triage layer:
...
A country risk workflow should never hide where advisory input came from. CYBERSPACE's CII score exposes advisory provenance so downstream users can distinguish:
...
With REST, use the intelligence service from the [API reference](https://www.cyberspace.app/docs/api-reference). For production systems, generate a typed client from the bundled OpenAPI spec and keep the response fields explicit.
...
The Country Instability Index is CYBERSPACE's 0-100 country-level risk score. It combines structural and live signals such as conflict, unrest, security events, information velocity, advisory input, and other risk indicators.

**Can CYBERSPACE replace a human country analyst?**
No. CYBERSPACE is a data and workflow layer. It helps analysts collect consistent evidence, catch changes faster, and write clearer memos. Human judgment is still needed for decisions.
